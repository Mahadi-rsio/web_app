...
import { ChartLineUp, Gear, Timer, CaretRight } from "@phosphor-icons/react"
import { useRouter, usePathname } from "next/navigation"

export default function CronJobLayout({ children }: { children: React.ReactNode }) {
      ...
      <Paper elevation={0} sx={{ borderBottom: '1px solid #E0E4E8', bgcolor: '#fff', pt: 1 }}>
        <Container maxWidth="xl">
          <Stack spacing={1} sx={{ mb: 2 }}>
            ...
            <Typography variant="h5" fontWeight="800">Cron Job Dashboard</Typography>
          </Stack>
          ...
          >
            ...
            <Tab value="logs" icon={<Timer size={20} />} iconPosition="start" label="Logs" />
